...
abstract class BmcOutputStream extends OutputStream {
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(BmcOutputStream.class);
    ...
    public BmcOutputStream(final UploadManager uploadManager, final BiFunction<Long, InputStream, UploadRequest> requestBuilderFn) {
    ...
    public void close() throws IOException {
        ...
        try {
            ...
            final UploadRequest request = this.requestBuilderFn.apply(this.getInputStreamLengthInBytes(), fromBufferedStream);
