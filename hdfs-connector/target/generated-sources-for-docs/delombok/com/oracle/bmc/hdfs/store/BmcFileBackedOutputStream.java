...
public class BmcFileBackedOutputStream extends BmcOutputStream {
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(BmcFileBackedOutputStream.class);
    private final BmcPropertyAccessor propertyAccessor;
    private File bufferFile;

    public BmcFileBackedOutputStream(final BmcPropertyAccessor propertyAccessor, final UploadManager uploadManager, final BiFunction<Long, InputStream, UploadRequest> requestBuilderFn) {
