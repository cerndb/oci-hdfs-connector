...
abstract class BmcFSInputStream extends FSInputStream {
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(BmcFSInputStream.class);
    ...
    private void verifyInitialized(final long startPosition) throws IOException, BmcException {
        ...
        LOG.debug("Opened object with etag {} and size {}", response.getETag(), response.getContentLength());
    ...
    BmcFSInputStream(final ObjectStorage objectStorage, final FileStatus status, final Supplier<GetObjectRequest.Builder> requestBuilder, final Statistics statistics) {
    ...
    protected void setSourceInputStream(final InputStream sourceInputStream) {
