...
class BmcPropertyAccessor {
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(BmcPropertyAccessor.class);
    ...
    @java.beans.ConstructorProperties({"configuration", "propertyOverrideSuffix"})
    public BmcPropertyAccessor(final Configuration configuration, final String propertyOverrideSuffix) {
